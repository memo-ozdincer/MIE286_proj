...
On misses ($n = 305$), there was a systematic spatial bias: participants clicked 9.1\,px below and 30.3\,px to the right of the target on average. A one-sample $t$-test on the vertical offset confirmed the downward bias was significant ($t = -2.41$, $p = .017$), likely reflecting cursor hotspot position or hand biomechanics. The visual condition produced a wider miss scatter (SD of miss distance: visual $= 73.2$\,px, auditory $= 58.1$\,px), consistent with more impulsive clicking under speed pressure.
