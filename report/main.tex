...
72 individuals (ages 18--24, university students) participated via convenience sampling. Initially, the experiment used 30 trials per block, but preliminary analysis showed that 30 trials produced unstable per-participant statistics and the effects of interest (streak patterns, tilt cascades) were not visible. We therefore increased to 60 trials per block. Only participants who completed the full 60-trial protocol are included in the analysis ($N = 41$). Table~\ref{tab:sample} summarizes the final sample.
...
\quad Mouse & 18 & 588 & 96.9 \\
\quad Trackpad & 16 & 792 & 95.8 \\
\quad Other & 7 & 681 & 97.0 \\[4pt]
\multicolumn{4}{l}{\textit{Gaming Frequency}} \\
\quad Daily & 9 & 598 & 99.4 \\
\quad Weekly & 10 & 680 & 95.7 \\
\quad Never & 9 & 695 & 97.0 \\
\quad Rarely & 13 & 739 & 94.9 \\
\bottomrule
\end{tabular}
\end{table}
...
On misses ($n = 171$), there was a systematic spatial bias: participants clicked 5.4\,px below and 1.3\,px to the right of the target on average, likely reflecting cursor hotspot position or hand biomechanics.
