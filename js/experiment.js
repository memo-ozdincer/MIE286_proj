...
class Experiment {
  ...
  _showEnd() {
    ...
    this._renderScreen(`
      ...
      <a href="leaderboard.html${window.location.hash}" class="btn btn-secondary" style="display:inline-block;margin-left:0.5rem;text-decoration:none;">View Leaderboard</a>
    `);
